                        ...
                        @if(in_array("master_manage",$userPermission))
                            <li class="parent {{$masterManagementTab or ''}}" title="Master Managemet"><a href="#"><i
                                ...
                                <ul class="sub-menu">
                                    ...
                                    @endif
                                        <li class="{{$departmentTab or ''}}">
                                            <a href="{{url('/department/list')}}">{{trans('app.department')}}</a>
                                        </li>
                                        <li class="{{$employeeTab or ''}}">
                                            <a href="{{url('/employee/list')}}">{{trans('app.employee')}}</a>
                                        </li>
                                        <li class="{{$noDepartmentTab or ''}}">
                                            <a href="{{url('/employee/list/no-department')}}">{{trans('app.employee')}} (No department)</a>
                                        </li>
