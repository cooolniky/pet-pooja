        ...
        <div class="main-content container-fluid">
            <div class="splash-container">
                <div class="panel panel-default panel-border-color panel-border-color-primary">
                    <div class="panel-heading img-resposive"><img src="{{url('img/petpooja-logo-red.svg')}}" alt="logo" width="102" height="27" class="logo-img"><span class="splash-description">{{trans('app.login_throttle')}}</span></div>
